...
func xponderGlobalPreConfigValidate(obj objects.XponderGlobal) error {
	var err error
	fmt.Println("Pre config validate called for Xponder Global object")
	return err
}

func xponderGlobalPostConfigProcessing(obj objects.XponderGlobal) error {
	var err error
	fmt.Println("Post config processing called for Xponder Global object")
	return err
}
