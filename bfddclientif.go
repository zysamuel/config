		...
		if clnt.ClientHdl != nil {
			...
			if bulkInfo != nil && bulkInfo.Count != 0 {
				...
				for i := 0; i < int(bulkInfo.Count); i++ {
					...
					ret_obj.RequiredMinRxInterval = string(bulkInfo.BfdIntfStateList[i].RequiredMinRxInterval)
					ret_obj.DemandEnabled = bool(bulkInfo.BfdIntfStateList[i].DemandEnabled)
					ret_obj.AuthenticationType = string(bulkInfo.BfdIntfStateList[i].AuthenticationType)
					ret_obj.Enabled = bool(bulkInfo.BfdIntfStateList[i].Enabled)
					ret_obj.DesiredMinTxInterval = string(bulkInfo.BfdIntfStateList[i].DesiredMinTxInterval)
					...
					ret_obj.IfIndex = int32(bulkInfo.BfdIntfStateList[i].IfIndex)
					ret_obj.AuthenticationKeyId = int32(bulkInfo.BfdIntfStateList[i].AuthenticationKeyId)
					ret_obj.RequiredMinEchoRxInterval = string(bulkInfo.BfdIntfStateList[i].RequiredMinEchoRxInterval)
		...
		if clnt.ClientHdl != nil {
			...
			if bulkInfo != nil && bulkInfo.Count != 0 {
				...
				for i := 0; i < int(bulkInfo.Count); i++ {
					...
					ret_obj.RequiredMinRxInterval = string(bulkInfo.BfdSessionStateList[i].RequiredMinRxInterval)
					ret_obj.AuthType = string(bulkInfo.BfdSessionStateList[i].AuthType)
					...
					ret_obj.DesiredMinTxInterval = string(bulkInfo.BfdSessionStateList[i].DesiredMinTxInterval)
					ret_obj.SessionId = int32(bulkInfo.BfdSessionStateList[i].SessionId)
					ret_obj.RemoteSessionState = string(bulkInfo.BfdSessionStateList[i].RemoteSessionState)
					...
					ret_obj.RemoteMinRxInterval = string(bulkInfo.BfdSessionStateList[i].RemoteMinRxInterval)
					...
					ret_obj.IfIndex = int32(bulkInfo.BfdSessionStateList[i].IfIndex)
					ret_obj.LocalDiscriminator = uint32(bulkInfo.BfdSessionStateList[i].LocalDiscriminator)
					ret_obj.SessionState = string(bulkInfo.BfdSessionStateList[i].SessionState)
					...
					ret_obj.LocalDiagType = string(bulkInfo.BfdSessionStateList[i].LocalDiagType)
					objs = append(objs, ret_obj)
				}
